...
datasaurus_dozen |> 
  ...
  write_csv(here::here("data", "SAMOS", "other_data", "random_not.csv"))
```

Retrieve [these data](../../data/SAMOS/other_data/random_not.csv) and calculate the mean and standard deviation of the variables.

```{r code-xy-read-csv-here-here}
#| eval: false
#| echo: false
xy <- read_csv(here::here("data", "SAMOS", "other_data", "random_not.csv"))
xy |> 
...
library(lubridate)
read_csv(here::here("data", "SAMOS", "other_data", "SACTN_SAWS.csv")) |> 
...
fwrite(NWA, file = here::here("data", "SAMOS", "other_data", "NWA_Hovmoller.csv"))
```
...
NWA <- fread(here::here("data", "SAMOS", "other_data", "NWA_Hovmoller.csv"))
