...
```{r fig-woa-core-map-temp, fig.width=6, fig.asp=0.7, out.width="85%"}
...
```{r fig-woa-core-ts, fig.width=5.5, fig.asp=0.7, out.width="75%"}
...
```{r fig-woa-core-profile, fig.width=9, fig.asp=0.5, out.width="100%"}
#| fig.width: 8
#| fig.height: 6
#| out.width: "100%"
