...
## Question 2
Please refer to the [two-sided two-sample *t*-test in the lecture](../basic_stats/07-t_tests.html#two-sided-two-sample-t-test). It is recreated here:
