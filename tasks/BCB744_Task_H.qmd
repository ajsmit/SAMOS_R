...
## Question 1
a. Examine the content of the regression model object `sparrows.lm` produced in the [linear regression](../basic_stats/09-regressions.html) chapter. Explain the meaning of the components within, and tell us how they relate to the model summary produced by `summary(sparrows.lm)`. **(/5)**
